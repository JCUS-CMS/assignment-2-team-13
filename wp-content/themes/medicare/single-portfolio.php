...
if ( isset( $boldthemes_options['pf_settings_page_slug'] ) && $boldthemes_options['pf_settings_page_slug'] != '' ) {
	MedicareTheme::$boldthemes_page_for_header_id = boldthemes_get_id_by_slug( $boldthemes_options['pf_settings_page_slug'] );
}
...
if ( have_posts() ) {
	...
	if ( $categories_html != '' ) {
		$meta_right_html .= '<dt>' . esc_html__( 'Category', 'medicare' ) . '</dt>';
							...
							<div class="rowItemContent">
								...
								foreach( $slider_images as $slider_image ) {
									echo '<div class="slidedItem fullScreenHeight" data-thumb="' . esc_attr( $slider_image['thumb'] ) . '" data-text="' . esc_attr( $slider_image['text'] ) . '" data-description="' . esc_attr( $slider_image['description'] ) . '">';
										echo '<div class="variableImg"><img src="' . esc_url_raw( $slider_image['src'] ) . '" alt="' . esc_attr( $slider_image['src'] ) . '"></div>';
									echo '</div><!-- /.slidedItem -->';
								} ?>
								</div><!-- /slided -->
								...
								<div class="btInfoBar">
									<div class="btInfoBarMeta">
										...
										<p><strong><?php esc_html_e( 'Title:', 'medicare' ); ?></strong> <span class="btPortfolioSliderCaption"></span></p>
										<p><strong><?php esc_html_e( 'Description:', 'medicare' ); ?></strong> <span class="btPortfolioSliderDescription"></span></p>
									</div><!-- /boldInfoBarMeta -->
								</div><!-- /boldInfoBar -->
							</div><!-- /rowItemContent -->
						</div><!-- /rowItem -->
