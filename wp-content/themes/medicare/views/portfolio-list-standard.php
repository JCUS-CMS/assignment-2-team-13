<?php
	...
	$share_html = '<div class="btIconRow">' . ( function_exists( 'boldthemes_get_share_html' ) ? boldthemes_get_share_html( $permalink, 'pf', 'btIcoSmallSize', 'btIcoOutlineType btIcoAccentColor' ) : '' ) . '</div>';
